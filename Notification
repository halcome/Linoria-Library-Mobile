...
local Notification = {}
function Notification.NormalNotification(conpigs)
	conpigs = conpigs or {}
...
function Notification.ReplyNofitication(conpigs) -- or you can call it TextboxNofitication
	conpigs.Title = conpigs.Title or "Notification"
	conpigs.Description = conpigs.Description or "why are you so ugly?"
	conpigs.ImagesID = conpigs.ImagesID or "http://www.roblox.com/asset/?id=14154109741"
	conpigs.SoundID = conpigs.SoundID or ""
	conpigs.PlaceholderText = conpigs.PlaceholderText or "Type a reply"
	conpigs.SendCallback = conpigs.SendCallback or function() print("Notification") end
